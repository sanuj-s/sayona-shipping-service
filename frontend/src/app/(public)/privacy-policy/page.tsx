...
export const metadata: Metadata = {
  ...
  description: "Privacy Policy for Sayona Shipping Services. Learn how we handle your data.",
};
          ...
          <Card variant="elevated" padding="lg">
            <div className="prose prose-neutral dark:prose-invert max-w-none space-y-6 text-[var(--foreground-secondary)] leading-relaxed">
              ...
              <div>
                ...
                <p>
                  Your shipment data is treated with enterprise-grade confidentiality. Sayona Shipping Services enforces strict
