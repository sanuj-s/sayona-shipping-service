...
# The replaced about section had extra tags left over below it:
#             </section>
#             <p class="opacity-9 lh-lg">
#                 Since our founding in 2020...
#             </p>
#     </div>
#     </section>
#
# We need to completely rewrite the About and Experience sections cleanly.

clean_about_and_stats = """            <!-- Page Header -->
            <section class="page-header section-alt text-center">
                <div class="container">
                    <h1 class="color-text-main mb-1" style="font-size: 3rem;">About Sayona Shipping</h1>
                    <p class="color-text-secondary container-sm text-center"
                        style="font-size: 1.2rem; max-width: 700px; margin: 0 auto;">
                        Trusted global logistics partner delivering reliable cargo solutions since 2020.
                    </p>
                </div>
            </section>
                ...
                <div class="container">
                    <div class="about-grid">
                        ...
                        <div class="about-image">
                            <img src="/src/assets/images/ship_large.png" alt="Logistics Operations" loading="lazy">
                        </div>
                    </div>
                </div>
            </section>
